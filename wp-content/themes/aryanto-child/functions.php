...
function tie_theme_child_styles_scripts() {
	...
	wp_enqueue_style( 'icon-font', get_stylesheet_directory_uri().'/assets/fonts/iconfont/iconfont.css', '' );
	/* Uncomment this line if you want to add custom javascript */
	//wp_enqueue_script( 'herbal-child-js', get_stylesheet_directory_uri() .'/js/scripts.js', '', false, true );
}