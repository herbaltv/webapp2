...
<?php
	if(
		apply_filters( 'Herbs/is_header_active', true ) &&
		(
			(
	...
	<aside class="side-aside normal-side tie-aside-effect dark-skin dark-widgetized-area <?php echo $mobile_menu_layout ?>" aria-label="<?php esc_html_e( 'Secondary Sidebar', HERBS_TEXTDOMAIN ); ?>">
		<div data-height="100%" class="side-aside-wrapper has-custom-scroll">
			...
			<div id="mobile-container">
				...
				<?php
					...
					HERBS_HELPER::get_template_part( 'templates/header/components', '', array( 'components_id' => 'mobile' ) );
