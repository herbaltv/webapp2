...
if( $block['style'] != 'row' && $count == 1 ):
	...
	$background = tie_get_option( 'lazy_load' ) ? 'data-lazy-bg="'. esc_attr( tie_thumb_src( HERBS_THEME_SLUG.'-image-post' ) ) .'"' : 'style="'. esc_attr( tie_thumb_src_bg( HERBS_THEME_SLUG.'-image-post' ) ) .'"'; ?>
...
<?php else:
	...
	$background = tie_get_option( 'lazy_load' ) ? 'data-lazy-bg="'. esc_attr( tie_thumb_src( HERBS_THEME_SLUG.'-image-large' ) ) .'"' : 'style="'. esc_attr( tie_thumb_src_bg( HERBS_THEME_SLUG.'-image-large' ) ) .'"'; ?>
