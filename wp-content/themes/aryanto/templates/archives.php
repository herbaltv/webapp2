...
$b_args = array(
	'uncropped_image' => isset( $uncropped_image ) ? $uncropped_image : HERBS_THEME_SLUG.'-image-post',
	...
	'title_length'    => 0,
	'is_full'         => ! HERBS_HELPER::has_sidebar(),
...
while ( have_posts() ) : the_post();
	...
	HERBS_HELPER::get_template_part( 'templates/loops/loop', $layout, $loop_args );

	do_action( 'Herbs/after_post_in_archives', $layout, $count );
