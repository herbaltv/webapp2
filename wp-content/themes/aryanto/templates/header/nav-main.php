...
<div class="main-nav-wrapper">
	<nav id="main-nav" <?php echo ( $live_search_data_skin ); ?> class="<?php echo esc_attr( $main_menu_class ) ?>" <?php echo ( $header_line_height ) ?> aria-label="<?php esc_html_e( 'Primary Navigation', HERBS_TEXTDOMAIN ); ?>">
		<div class="container">
			...
			<div class="main-menu-wrapper">
					...
					if( $header_layout == 1 ){ ?>
						<div class="header-layout-1-logo <?php echo esc_attr( $has_line_height ) ?>" <?php echo ( $logo_width ) ?>>
							<?php
								...
								do_action( 'Herbs/Logo/before' );

								tie_logo();

								do_action( 'Herbs/Logo/after' );
							?>
						</div>
						<?php
					}
				...
				<div id="menu-components-wrap">
					...
					<div class="main-menu main-menu-wrap tie-alignleft">
						<?php
							...
							if( ! tie_get_option( 'disable_mega_menu' ) ){
								$menu_args['walker'] = new HERBS_MEGA_MENU();
							}
					...
					<?php
						...
						do_action( 'Herbs/after_main_menu' );

						// Get components template
						HERBS_HELPER::get_template_part( 'templates/header/components', '', array( 'components_id' => 'main-nav' ) );

						do_action( 'Herbs/after_main_components' );
