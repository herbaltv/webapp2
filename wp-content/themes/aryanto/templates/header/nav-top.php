...
<nav id="top-nav" <?php echo ( $live_search_data_skin ); ?>class="<?php echo esc_attr( $top_nav_class ) ?>" aria-label="<?php esc_html_e( 'Secondary Navigation', HERBS_TEXTDOMAIN ); ?>">
	<div class="container">
		<div class="topbar-wrapper">
			...
			<div class="tie-alignleft">
				<?php
					...
					if( tie_get_option( 'top-nav-area-1' ) == 'components' ){
						HERBS_HELPER::get_template_part( 'templates/header/components', '', array( 'components_id' => 'top-nav', 'position' => 'area-1' ) );
					}
				?>
			</div><!-- .tie-alignleft /-->
			...
			<div class="tie-alignright">
				...
				if( tie_get_option( 'top-nav-area-2' ) == 'components' ){
					HERBS_HELPER::get_template_part( 'templates/header/components', '', array( 'components_id' => 'top-nav', 'position' => 'area-2' ) );
				}
