			...
			<?php
				...
				if( $feedburner = tie_get_option( 'post_newsletter_feedburner' )){ ?>
					...
					<form action="https://feedburner.google.com/fb/a/mailverify" method="post" class="subscribe-form" target="popupwindow" onsubmit="window.open('https://feedburner.google.com/fb/a/mailverify?uri=<?php echo esc_attr( $feedburner ) ?>', 'popupwindow', 'scrollbars=yes,width=550,height=520');return true">
						...
						<input class="subscribe-input required email" id="email" type="text" name="email" placeholder="<?php esc_html_e( 'Enter your Email address', HERBS_TEXTDOMAIN ); ?>">
						...
						<form action="<?php echo esc_attr( $mailchimp ) ?>" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="subscribe-form validate" target="_blank" novalidate>
							<div id="mc_embed_signup_scroll">
								<div class="mc-field-group">
									<label class="screen-reader-text" for="mce-EMAIL"><?php esc_html_e( 'Enter your Email address', HERBS_TEXTDOMAIN ); ?></label>
									<input type="email" value="" id="mce-EMAIL" placeholder="<?php esc_html_e( 'Enter your Email address', HERBS_TEXTDOMAIN ); ?>" name="EMAIL" class="subscribe-input required email" id="mce-EMAIL">
								</div>
								<div id="mce-responses" class="clear">
									<div class="response" id="mce-error-response" style="display:none"></div>
									<div class="response" id="mce-success-response" style="display:none"></div>
								</div>
								<input type="submit" value="<?php esc_html_e( 'Subscribe', HERBS_TEXTDOMAIN ); ?>" name="subscribe" id="mc-embedded-subscribe" class="button subscribe-submit">
							</div>
						</form>
					</div>
					<?php
