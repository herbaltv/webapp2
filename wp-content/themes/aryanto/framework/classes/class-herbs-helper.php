...
if( ! class_exists( 'HERBS_HELPER' )){
	...
	class HERBS_HELPER {
		...
		public static function get_supported_post_types(){
			...
			$supported_post_types = apply_filters( 'Herbs/Settings/default_post_types', $default_post_types );
		...
		public static function is_js_minified(){
			...
			*/
			...
			if( HERBS_BWPMINIFY_IS_ACTIVE || function_exists( 'fvm_download_and_cache' ) || class_exists( 'evScriptOptimizer' ) ){
				return true;
			}
