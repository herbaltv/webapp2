<?php
	...
	tie_build_theme_option(
		array(
			'title' => esc_html__( 'Header Settings', HERBS_TEXTDOMAIN ),
			'id'    => 'header-settings-tab',
			'type'  => 'tab-title',
		));


	$headers_path   = HERBS_TEMPLATE_URL. '/framework/admin/assets/images/headers';
	$top_nav_class  = '';
	$header_class   = '';
	$main_nav_class = '';
...
<div id="header-preview-wrapper">
	...
	tie_build_theme_option(
		array(
			'title' => esc_html__( 'Header Layout', HERBS_TEXTDOMAIN ),
			'id'    => 'header-layout',
			'type'  => 'header',
		));
	...
	tie_build_theme_option(
		array(
			'name'   => esc_html__( 'Header Layout', HERBS_TEXTDOMAIN ),
			'id'     => 'header_layout',
			'type'   => 'radio',
			'toggle' => array(
				'3' => '',
				...
				'1' => '',),
			'options' => array(
				'3' => esc_html__( 'Layout', HERBS_TEXTDOMAIN ) .' #1',
				'2'	=> esc_html__( 'Layout', HERBS_TEXTDOMAIN ) .' #2',
				'1' => esc_html__( 'Layout', HERBS_TEXTDOMAIN ) .' #3',
			)));
	?>

	<div class="tie-section-title tie-section-tabs header-settings-tabs">
		<a href="#main-nav-settings" class="active"><?php esc_html_e( 'Main Nav Settings', HERBS_TEXTDOMAIN ) ?></a>
		<a href="#top-nav-settings"><?php esc_html_e( 'Secondry Nav Settings',  HERBS_TEXTDOMAIN ) ?></a>
	</div>
	...
	echo'<div id="top-nav-settings" class="top-main-nav-settings">';
		...
		tie_build_theme_option(
			array(
				'name' => esc_html__( 'Boxed Layout', HERBS_TEXTDOMAIN ),
				'id'   => 'top_nav_layout',
				'type' => 'checkbox',
			));
		...
		tie_build_theme_option(
			array(
				'name' => esc_html__( 'Below The Header', HERBS_TEXTDOMAIN ),
				'id'   =>  'top_nav_position',
				'type' => 'checkbox',
			));
		...
		tie_build_theme_option(
			array(
				'name'   => esc_html__( "Today's date", HERBS_TEXTDOMAIN ),
				'id'     => 'top_date',
		...
		tie_build_theme_option(
			array(
				'name'    => esc_html__( "Today's date format", HERBS_TEXTDOMAIN ),
				'id'      => 'todaydate_format',
				'type'    => 'text',
				'default' => 'l ,  j  F Y',
				'hint'    => '<a target="_blank" href="http://codex.wordpress.org/Formatting_Date_and_Time">'.esc_html__( 'Documentation on date and time formatting', HERBS_TEXTDOMAIN ).'</a>',
			));
		...
		tie_build_theme_option(
			array(
				'name'   => esc_html__( 'Left Area', HERBS_TEXTDOMAIN ),
				'id'     => 'top-nav-area-1',
				'type'   => 'radio',
				'toggle' => array(
					'none'       => '',
				...
				'options' => array(
					...
					'components' => esc_html__( 'Components', HERBS_TEXTDOMAIN ),
					'menu'       => esc_html__( 'Menu', HERBS_TEXTDOMAIN ),
					'breaking'   => esc_html__( 'Breaking News', HERBS_TEXTDOMAIN ),
			)));

		tie_build_theme_option(
			array(
				'name'   => esc_html__( 'Right Area', HERBS_TEXTDOMAIN ),
				'id'     => "top-nav-area-2",
				'type'   => "radio",
				'toggle' => array(
					'none'       => '',
		...
		tie_header_area_options( esc_html__( 'Secondry Nav Components', HERBS_TEXTDOMAIN ), 'top-nav-components' );

		echo'<div class="breaking-news-all-options top-nav-area-1-options">';

		tie_build_theme_option(
			array(
				'title' => esc_html__( 'Breaking News', HERBS_TEXTDOMAIN ),
		...
		tie_build_theme_option(
			array(
				...
				'id'          => 'breaking_title',
				'placeholder'	=> esc_html__( 'Trending', HERBS_TEXTDOMAIN ),
				'type'        => 'text',
			));
		...
		tie_build_theme_option(
			array(
				...
				'options' => array(
					...
					'custom'   => esc_html__( 'Custom Text', HERBS_TEXTDOMAIN ),
				)));
		...
		tie_build_theme_option(
			array(
				...
				'hint'  => esc_html__( 'Enter a tag name, or names separated by comma.', HERBS_TEXTDOMAIN ),
				'id'    => 'breaking_tag',
				'class'	=> 'breaking_type',
				'type'  => 'text',
			));
		...
		<div class="option-item breaking_type-options" id="breaking_custom-item">
			...
			<input id="breaking_news_button"  class="button" type="button" value="<?php esc_html_e( 'Add', HERBS_TEXTDOMAIN ) ?>" />

			<?php

				tie_build_theme_option(
					array(
						'text' => esc_html__( 'Text and Link are required.', HERBS_TEXTDOMAIN ),
	...
	tie_build_theme_option(
		array(
			'name' => esc_html__( 'Above The Header', HERBS_TEXTDOMAIN ),
			'id'   => 'main_nav_position',
			'type' => 'checkbox',
			'class' => 'main-nav-related',
		));

	tie_header_area_options( esc_html__( 'Main Nav Components', HERBS_TEXTDOMAIN ), 'main-nav-components' );
	...
	echo '<div id="sticky-nav-section" class="main-nav-related-options">';
		...
		tie_build_theme_option(
			array(
				'title' => esc_html__( 'Sticky Menu', HERBS_TEXTDOMAIN ),
				'id'    => 'sticky-menu',
				'type'  => 'header',
			));
		...
		echo '<div id="sticky-menu-items">';
			...
			tie_build_theme_option(
				array(
					'name'    => esc_html__( 'Sticky Menu behavior', HERBS_TEXTDOMAIN ),
					'id'      => 'sticky_behavior',
					'type'    => 'radio',
					'options' => array(
			...
			tie_build_theme_option(
				array(
					'name'   => esc_html__( 'Sticky Menu Logo', HERBS_TEXTDOMAIN ),
					'id'     => 'sticky_logo_type',
				...
				echo '<div id="sticky-logo-options">';
					...
					tie_build_theme_option(
						array(
							'name'   => esc_html__( 'Custom Sticky Menu Logo', HERBS_TEXTDOMAIN ),
							'hint'   => esc_html__( 'Use this option to set a custom logo in the sticky menu or Disable it to use the main logo.', HERBS_TEXTDOMAIN ),
...
function tie_header_area_options( $text_field, $area_name ){ ?>
	...
	<div id="<?php echo esc_attr( $area_name ) ?>-search">
		...
		<?php
			...
			tie_build_theme_option(
				array(
					'name' => esc_html__( 'Live Search', HERBS_TEXTDOMAIN ),
			...
			tie_build_theme_option(
				array(
					'name'   => esc_html__( 'Search Layout', HERBS_TEXTDOMAIN ),
					...
					'options' => array(
						'default' => esc_html__( 'Default', HERBS_TEXTDOMAIN ),
						'compact' => esc_html__( 'Compact', HERBS_TEXTDOMAIN ),
				)));

			tie_build_theme_option(
				array(
					'name'  => esc_html__( 'Type To Search', HERBS_TEXTDOMAIN ),
	...
	<?php
		...
		tie_build_theme_option(
			array(
				'name'   => esc_html__( 'Slide Sidebar', HERBS_TEXTDOMAIN ),
		...
		tie_build_theme_option(
			array(
				'name'   => esc_html__( 'Random Article Button', HERBS_TEXTDOMAIN ),
		...
		tie_build_theme_option(
			array(
				'name'   => esc_html__( 'Tag Navigation', HERBS_TEXTDOMAIN ),
				'id'     => 'menu_nav_tag',
				'type'   => 'checkbox'
			));
	...
	<div id="<?php echo esc_attr( $area_name ) ?>-social-icons">
		...
		<?php
			...
			tie_build_theme_option(
				array(
					'name'   => esc_html__( 'Social icons layout', HERBS_TEXTDOMAIN ),
					...
					'options' => array(
						'default' => esc_html__( 'Default', HERBS_TEXTDOMAIN ) ,
						'list'    => esc_html__( 'Menu with names', HERBS_TEXTDOMAIN ),
						'grid'    => esc_html__( 'Grid Menu', HERBS_TEXTDOMAIN ),
				)));
	...
	<?php
		...
		tie_build_theme_option(
			array(
				'name'   => esc_html__( 'Weather', HERBS_TEXTDOMAIN ),
	...
	<div id="<?php echo esc_attr( $area_name ) ?>-weather">
		...
		<?php
			...
			if( ! tie_get_option( 'api_openweather' ) ){
				...
				tie_build_theme_option(
					array(
						'text'   => esc_html__( 'You need to set the Weather API Key in the theme options page > API Keys.', HERBS_TEXTDOMAIN ),
						'type'   => 'error',
					));
			}
			...
			tie_build_theme_option(
				array(
					'name'  => esc_html__( 'Location', HERBS_TEXTDOMAIN ),
					'hint'  => esc_html__( '(i.e: London,UK or New York City)', HERBS_TEXTDOMAIN ),
			...
			tie_build_theme_option(
				array(
					'name'  => esc_html__( 'Custom City Name', HERBS_TEXTDOMAIN ),
			...
			tie_build_theme_option(
				array(
					'name'  => esc_html__( 'Units', HERBS_TEXTDOMAIN ),
			...
			tie_build_theme_option(
				array(
					'name'  => esc_html__( 'Animated Icons?', HERBS_TEXTDOMAIN ),
