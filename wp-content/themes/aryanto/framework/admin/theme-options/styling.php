...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Apply custom styling by inline code', HERBS_TEXTDOMAIN ),
		'hint' => esc_html__( 'check this option if you have problems with styling because of styling file rewrite permissions.', HERBS_TEXTDOMAIN ),
		'id'   => 'inline_css',
		'type' => 'checkbox',
	));
...
tie_build_theme_option(
	array(
		'title' => esc_html__( 'Custom Body Classes', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Custom Body Classes', HERBS_TEXTDOMAIN ),
		'id'   => 'body_class',
		'type' => 'text',
	));
...
tie_build_theme_option(
	array(
		'name'	  => esc_html__( 'Predefined skins', HERBS_TEXTDOMAIN ),
		'id'		  => '',
		'class'		=> 'predefined-skins',
		'type'	  => 'select',
		'options' => array(
			''            => esc_html__( 'Choose a Skin', HERBS_TEXTDOMAIN ),
			'default'     => esc_html__( 'Default',       HERBS_TEXTDOMAIN ),
			'blue'        => esc_html__( 'Blue',          HERBS_TEXTDOMAIN ),
			'yellow'      => esc_html__( 'Yellow',        HERBS_TEXTDOMAIN ),
			'alizarin'    => esc_html__( 'Alizarin',      HERBS_TEXTDOMAIN ),
			'sand'        => esc_html__( 'Sand',          HERBS_TEXTDOMAIN ),
			'royal'       => esc_html__( 'Royal',         HERBS_TEXTDOMAIN ),
			'mint'        => esc_html__( 'Mint',          HERBS_TEXTDOMAIN ),
			'stylish_red' => esc_html__( 'Stylish Red',   HERBS_TEXTDOMAIN ),
			'twilight'    => esc_html__( 'Twilight',      HERBS_TEXTDOMAIN ),
			'coffee'      => esc_html__( 'Coffee',        HERBS_TEXTDOMAIN ),
			'ocean'       => esc_html__( 'Ocean',         HERBS_TEXTDOMAIN ),
			'cyan'        => esc_html__( 'Cyan',          HERBS_TEXTDOMAIN ),
			'facebook'    => esc_html__( 'Facebook',      HERBS_TEXTDOMAIN ),
			'sahifa'      => esc_html__( 'Sahifa',        HERBS_TEXTDOMAIN ),
			'mist'        => esc_html__( 'Mist',          HERBS_TEXTDOMAIN ),
			'serene'      => esc_html__( 'Serene',        HERBS_TEXTDOMAIN ),
			'fall'        => esc_html__( 'Fall',          HERBS_TEXTDOMAIN ),
		)));
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Custom Primary Color', HERBS_TEXTDOMAIN ),
		'id'   => 'global_color',
		'type' => 'color',
	));
...
tie_build_theme_option(
	array(
		'title' =>	esc_html__( 'Body', HERBS_TEXTDOMAIN ),
		'id'    => 'body-styling',
		'type'  => 'header',
	));
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Disable Boxed/Framed Layout Shadows', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Highlighted Text Color', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Links Text Color', HERBS_TEXTDOMAIN ),
		'id'   => 'links_color',
		'type' => 'color',
	));
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Links text HOVER color', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Borders Color', HERBS_TEXTDOMAIN ),
		'id'   => 'borders_color',
		'type' => 'color',
	));
...
tie_build_theme_option(
	array(
		'title' =>	esc_html__( 'Secondary Nav', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Text Color', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Links Color on mouse over', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Breaking news label background', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Rainbow Line Above Header', HERBS_TEXTDOMAIN ),
		'id'   => 'rainbow_header',
		'type' => 'checkbox',
	));
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Disable Header Shadows', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'title' =>	esc_html__( 'Main Navigation Styling', HERBS_TEXTDOMAIN ),
		'id'    => 'main-nav-styling',
		'type'  => 'header',
	));
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Main Nav Border Top Color', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Main Nav Border Top Width', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Main Nav Border Bottom Color', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Main Nav Border Bottom Width', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		...
		'title' =>	esc_html__( 'Main Content Styling', HERBS_TEXTDOMAIN ),
	));
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'In Post Links Color', HERBS_TEXTDOMAIN ),
		'id'   => 'post_links_color',
		'type' => 'color',
	));
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'In Post Links Color on mouse over', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Footer Border Top', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Widgets Title color', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Footer Margin Top', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Footer Padding Top', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Footer Padding Bottom', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Back to top button Background Color', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name'	=> esc_html__( 'Back to top button Arrow Color', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Mobile Header Background Color', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Mobile Header Background Image', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Mobile Menu Icon', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Social Icons color', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name' => esc_html__( 'Search Button color', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name'   => esc_html__( 'Mobile Menu Background', HERBS_TEXTDOMAIN ),
		...
		'options' => array(
			...
			'color'    => esc_html__( 'Color', HERBS_TEXTDOMAIN ),
			'gradient' => esc_html__( 'Gradient', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name'  => esc_html__( 'Background Gradient Color 1', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name'  => esc_html__( 'Background Gradient Color 2', HERBS_TEXTDOMAIN ),
...
tie_build_theme_option(
	array(
		'name'  => esc_html__( 'Tablets', HERBS_TEXTDOMAIN ) . '<br /><small>' . esc_html__( '768px - 1024px', HERBS_TEXTDOMAIN ) .'</small>',
		'id'    => 'css_tablets',
		'class' => 'tie-css',
		'type'  => 'textarea',
		'hint'  => sprintf( esc_html__( 'Use %s and it will be replaced with the primary color.', HERBS_TEXTDOMAIN ), '<code>primary-color</code>' ),
...
tie_build_theme_option(
	array(
		'name'  => esc_html__( 'Phones', HERBS_TEXTDOMAIN ) . '<br /><small>' . esc_html__( '0 - 768px', HERBS_TEXTDOMAIN ) .'</small>',
		'id'    => 'css_phones',
		'class' => 'tie-css',
		'type'  => 'textarea',
		'hint'  => sprintf( esc_html__( 'Use %s and it will be replaced with the primary color.', HERBS_TEXTDOMAIN ), '<code>primary-color</code>' ),
