<?php
/*
  Plugin Name: Herbs Page Widgets
  Plugin URI:
 ...
 */
 ...
 if( ! class_exists( 'HERBS_BUILDER_WIDGETS' )){

 	class HERBS_BUILDER_WIDGETS{
		...
		function print_scripts(){
	 		...
	 		if( ! empty( $screen->base ) && $screen->base == 'post' && $screen->id == 'page' ){
	 			...
	 			wp_enqueue_script(
          'tie-builder-widgets',
          HERBS_TEMPLATE_URL .'/framework/admin/assets/page-widgets.js',
          array(
            'jquery',
            'jquery-ui-sortable',
            'jquery-ui-draggable',
		...
		function _ajax_save_widget(){
			...
			$error        = '<p>' . esc_html__( 'An error has occured. Please reload the page and try again.', HERBS_TEXTDOMAIN ) . '</p>';
      ...
      echo "
        <div id=\"tie-show-sections-sidebars-wrap\">
          <h2>". esc_html__( 'Herbs Page Builder widgets areas', HERBS_TEXTDOMAIN )."</h2>
          <div>
		...
		public static function get_widgets( $sections = array() ) {
			...
			<div id="tie-sidebars-customize" class="tie-popup-block tie-popup-window">
				...
				<div class="tie-builder-item-top-container">
					<h2><?php esc_html_e( 'Manage Widgets', HERBS_TEXTDOMAIN ) ?></h2>
		    			...
		    			<div id="widgets-left">
		    				<div id="available-widgets" class="widgets-holder-wrap">
		    					<div class="sidebar-name">
		    						...
		    						<h3><?php esc_html__('Available Widgets', HERBS_TEXTDOMAIN); ?> <span id="removing-widget"><?php esc_html__('Deactivate', HERBS_TEXTDOMAIN); ?> <span></span></span></h3>
		    					</div>
		    					<div class="widget-holder">
		    						<p class="description"><?php esc_html__('Drag widgets from here to a sidebar on the right to activate them. Drag widgets back here to deactivate them and delete their settings.', HERBS_TEXTDOMAIN); ?></p>
		    						<div id="widget-list">
		    							<?php wp_list_widgets(); ?>
		    						</div>
		    						<br class='clear' />
		    		...
		    		<div class="widget-liquid-right">
		              ...
		              if( ! empty( $sections ) && is_array( $sections ) ){
		                  ...
		                  echo '<div id="wrap-'. $section_id .'" class="widgets-holder-wrap">';
		                    wp_list_widget_controls( $section_id, esc_html__('Section Widgets Area', HERBS_TEXTDOMAIN ) );
		                  echo '</div>';
		      					}
		              }
		    				?>
			...
			<div class="widgets-chooser">
				...
				<div class="widgets-chooser-actions">
					<button class="button-secondary"><?php esc_html_e( 'Cancel', HERBS_TEXTDOMAIN  ); ?></button>
					<button class="button-primary"><?php esc_html_e( 'Add Widget', HERBS_TEXTDOMAIN  ); ?></button>
				</div>
			</div>
			<?php
		}
