...
if( ! class_exists( 'HERBS_ADMIN_HELPER' )){

	class HERBS_ADMIN_HELPER {
		...
		public static function get_sliders( $label = false ){
			...
			// Default Label
			if( ! empty( $label ) ){
				$sliders[] = esc_html__( '- Select a Slider -', HERBS_TEXTDOMAIN );
			}
		...
		public static function get_categories( $label = false ){
			...
			// Default Label
			if( ! empty( $label ) ){
				$categories[] = esc_html__( '- Select a Category -', HERBS_TEXTDOMAIN );
			}
		...
		public static function get_menus( $label = false, $custom = false ){
			...
			// Default Label
			if( ! empty( $label ) ){
				$menus[] = esc_html__( '- Select a Menu -', HERBS_TEXTDOMAIN );
			}
		...
		public static function get_sidebars(){
			...
			$sidebars      = array( '' => esc_html__( 'Default', HERBS_TEXTDOMAIN ) );
