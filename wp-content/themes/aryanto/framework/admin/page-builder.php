...
function tie_page_builder_display_post_states( $post_states, $post ){
	...
	if ( tie_get_postdata( 'tie_builder_active', false, $post->ID ) ) {
		$post_states['tie_builder'] = esc_html__( 'Herbs Builder', HERBS_TEXTDOMAIN );
	}
...
function tie_save_page_builder( $post_id ){
	...
	if ( isset( $_POST['tie_hidden_flag'] )){
		...
		if( ! empty( $_POST['tie_home_cats'] ) ){
			$builder_data = apply_filters( 'Herbs/save_block', $_POST['tie_home_cats'] );
			$builder_data = HERBS_ADMIN_HELPER::array_filter( $builder_data );

			update_post_meta( $post_id, 'tie_page_builder', $builder_data );

			do_action( 'Herbs/builder/after_save', $post_id, $builder_data );
		}
		else{
			delete_post_meta( $post_id, 'tie_page_builder' );

			do_action( 'Herbs/builder/after_delete', $post_id );
		}
...
function tie_get_builder_section( $section_number = false, $section = array() ){
	...
	<li id="tie-section-<?php echo esc_attr( $section_number ) ?>" class="tie-builder-container parent-item sidebar-<?php echo esc_attr($section_settings['sidebar_position']) ?>">
		...
		<div class="tie-builder-section-title">
			<h4><?php esc_html_e( 'Section', HERBS_TEXTDOMAIN ) ?></h4>
		...
		<div class="tie-builder-content-area tie-popup-block tie-popup-window">
			...
			<div class="tie-builder-item-top-container">
				<h2><?php esc_html_e( 'Edit Section', HERBS_TEXTDOMAIN ) ?></h2>

				<a class="tie-primary-button button button-primary button-hero tie-edit-block-done" href="#"><?php esc_html_e( 'Done', HERBS_TEXTDOMAIN ) ?></a>

				<div class="tie-section-title tie-section-tabs blocks-settings-tabs">
					<a href="#" data-target="basic-block-settings" class="active"><?php esc_html_e( 'General', HERBS_TEXTDOMAIN ) ?></a>
					<a href="#" data-target="background-block-settings"><?php esc_html_e( 'Background', HERBS_TEXTDOMAIN ) ?></a>
					<a href="#" data-target="design-block-settings"><?php esc_html_e( 'Styling',  HERBS_TEXTDOMAIN ) ?></a>
				</div>
			</div>
			...
			<div class="tie-block-options-group">
				...
				echo '<div class="basic-block-settings block-settings">';
					...
					tie_build_theme_option(
						array(
							'title' => esc_html__( 'Section Title', HERBS_TEXTDOMAIN ),
							'type'  => 'header',
						));
					...
					tie_page_builder_section_option(
						...
						array(
							'name'   => esc_html__( 'Section Title', HERBS_TEXTDOMAIN ),
							'id'     => 'section_title',
							'type'   => 'checkbox',
					...
					tie_page_builder_section_option(
						...
						array(
							'name'        => esc_html__( 'URL', HERBS_TEXTDOMAIN ) .' '. esc_html__( '(optional)', HERBS_TEXTDOMAIN ),
							'id'          => 'url',
							'placeholder' => 'https://',
							'type'        => 'text',
						));
					...
					tie_page_builder_section_option(
						...
						array(
							'name'    => esc_html__( 'Title Style', HERBS_TEXTDOMAIN ),
							'id'      => 'title_style',
							'type'    => 'radio',
							'options' => array(
								''         => esc_html__( 'Default', HERBS_TEXTDOMAIN ),
								'centered' => esc_html__( 'Centered', HERBS_TEXTDOMAIN ),
								'big'      => esc_html__( 'Big', HERBS_TEXTDOMAIN ),
							)));
					...
					tie_build_theme_option(
						array(
							'title' => esc_html__( 'Section Width', HERBS_TEXTDOMAIN ),
							'type'  => 'header',
						));
					...
					tie_page_builder_section_option(
						...
						array(
							'name'   => esc_html__( '100% Interior Content Width', HERBS_TEXTDOMAIN ),
							'id'     => 'section_width',
							'type'   => 'checkbox',
							'hint'   => esc_html__( 'Select if the interior content is contained to site width or 100% width.', HERBS_TEXTDOMAIN ),
						));

					tie_build_theme_option(
						array(
							'title' => esc_html__( 'Sidebar Settings', HERBS_TEXTDOMAIN ),
							'type'  => 'header',
						));
					...
					tie_page_builder_section_option(
						...
						array(
							'name'    => esc_html__( 'Sidebar Position', HERBS_TEXTDOMAIN ),
							'id'      => 'sidebar_position',
				...
				echo '<div class="design-block-settings block-settings">';
					...
					tie_build_theme_option(
						array(
							'title' => esc_html__( 'Styling Settings', HERBS_TEXTDOMAIN ),
							'type'  => 'header',
						));
					...
					tie_page_builder_section_option(
						...
						array(
							'name'   => esc_html__( 'Custom Classes', HERBS_TEXTDOMAIN ),
							'id'     => 'custom_class',
							'type'   => 'text',
					));
					...
					tie_page_builder_section_option(
						...
						array(
							'name'   => esc_html__( 'Margin Top', HERBS_TEXTDOMAIN ),
							'id'     => 'margin_top',
							'type'   => 'number',
					));
					...
					tie_page_builder_section_option(
						...
						array(
							'name'   => esc_html__( 'Margin Bottom', HERBS_TEXTDOMAIN ),
							'id'     => 'margin_bottom',
							'type'   => 'number',
					));
		...
		<div class="tie-builder-section-inner">
			...
			<div class="tie-section-sidebar">
				<h4><?php esc_html_e( 'Sidebar', HERBS_TEXTDOMAIN ) ?></h4>
				<a href="#" data-widgets="<?php echo esc_attr( $section_settings['section_id'] ) ?>" class="tie-manage-widgets">
					<span class="dashicons dashicons-admin-generic"></span><?php esc_html_e( 'Manage Widgets', HERBS_TEXTDOMAIN ) ?>
				</a>
			</div>
			...
			<div class="tie-builder-blocks-wrapper-outer">
				...
				<div class="tie-add-new-block-wrapper">
					<a href="#" data-section="<?php echo esc_attr( $section_number ) ?>" class="tie-add-new-block tie-primary-button button button-primary button-large"><span><?php esc_html_e( 'Add Block', HERBS_TEXTDOMAIN ) ?></span></a>
				</div>
...
function tie_get_section_sidebar_options( $section_id, $section_number, $section_settings ){
	...
	echo '<div id="'. $section_id .'-sidebar-options" class="sections-sidebars-options">';
		...
		tie_page_builder_section_option(
			...
			array(
				'name'   => esc_html__( 'Predefined Sidebar', HERBS_TEXTDOMAIN ),
...
function tie_get_builder_blocks( $block_id = false, $section_id = false , $block = array() ){
	...
	$block_class_name = '';
	$categories = HERBS_ADMIN_HELPER::get_categories();
	...
	if( empty( $block ) ){
		$block = array(
			'style'           => 'default',
			'title'           => esc_html__( 'Block Title', HERBS_TEXTDOMAIN ),
			'number'          => 5,
			'excerpt'         => 'true',
			'read_more'       => 'true',
			'post_meta'       => 'true',
	...
	if( ! empty( $block['color'] ) ){
		$block_head_class = 'block-head-'.HERBS_STYLES::light_or_dark( $block['color'], false, 'dark', 'light' );
	...
	<li id="listItem_<?php echo esc_attr( $section_id .'-'. $block_id ) ?>" class="block-item parent-item <?php echo esc_attr( $block_class_name ) ?>">
		...
		<div class="tie-block-head <?php echo esc_attr( $block_head_class ) ?>" <?php echo ( $block_head_bg ) ?>>
			...
			<?php
				$block_img = esc_attr( HERBS_TEMPLATE_URL .'/framework/admin/assets/images/blocks/block-'. $block['style'] .'.png' );
			...
			<span class="block-e3lan-title"><?php esc_html_e( 'Ad', HERBS_TEXTDOMAIN ) ?></span>
			<span class="block-tabs-title"><?php esc_html_e( 'Tabs block', HERBS_TEXTDOMAIN ) ?></span>
		...
		<div class="tie-builder-content-area tie-popup-block tie-popup-window">
			...
			<div class="tie-builder-item-top-container">
				<h2><?php esc_html_e( 'Edit Block', HERBS_TEXTDOMAIN ) ?></h2>
			...
			<div class="tie-section-title tie-section-tabs blocks-settings-tabs">
				<a href="#" data-target="basic-block-settings" class="active"><?php esc_html_e( 'General', HERBS_TEXTDOMAIN ) ?></a>
				<a href="#" data-target="advanced-block-settings" class="block-settings-advanced"><?php esc_html_e( 'Advanced Settings',  HERBS_TEXTDOMAIN ) ?></a>
			</div>
			...
			<div class="option-item block-cat-tabs-item-options">
				<span class="tie-label"><?php esc_html_e( 'Categories', HERBS_TEXTDOMAIN ) ?></span>
				<div class="clear"></div>
			...
			<?php
				...
				tie_page_builder_option(
					...
					$value    = $block['title'],
					array(
						'name'   => esc_html__( 'Custom Title', HERBS_TEXTDOMAIN ) .' '. esc_html__( '(optional)', HERBS_TEXTDOMAIN ),
						'id'     => 'title',
				...
				tie_page_builder_option(
					...
					$value    = $block['icon'],
					array(
						'name'   => esc_html__( 'Icon', HERBS_TEXTDOMAIN ) .' '. esc_html__( '(optional)', HERBS_TEXTDOMAIN ),
						'id'     => 'icon',
				...
				tie_page_builder_option(
					...
					$value    = $block['url'],
					array(
						'name'        => esc_html__( 'Title URL', HERBS_TEXTDOMAIN ) .' '. esc_html__( '(optional)', HERBS_TEXTDOMAIN ),
						'id'          => 'url',
				...
				if( HERBS_WOOCOMMERCE_IS_ACTIVE ){
					...
					tie_page_builder_option(
						...
						array(
							'name'    => esc_html__( 'Products Categories', HERBS_TEXTDOMAIN ),
							'id'      => 'woo_cats',
							'type'    => 'select-multiple',
							'class'   => 'block-default-options block-products-item',
							'options' => HERBS_WOOCOMMERCE::categories(),
						));
				}
				...
				tie_page_builder_option(
					...
					array(
						...
						'id'     => 'tags',
						'hint'   => esc_html__( 'Will overide the Categories option.', HERBS_TEXTDOMAIN ),
						'type'   => 'text',
				...
				tie_page_builder_option(
					...
					array(
						'name'   => esc_html__( 'Exclude Posts', HERBS_TEXTDOMAIN ),
						'id'     => 'exclude_posts',
						'hint'   => esc_html__( 'Enter a post ID, or IDs separated by comma.', HERBS_TEXTDOMAIN ),
						'type'   => 'text',
				...
				if( tie_get_option( 'tie_post_views' ) ){
					$block_post_order['views'] = esc_html__( 'Most Viewed posts', HERBS_TEXTDOMAIN );
				}
				...
				tie_page_builder_option(
					...
					array(
						...
						'options'  => apply_filters( 'Herbs/Builder/Block/post_order_args', $block_post_order ),
					));
				...
				tie_page_builder_option(
					...
					$value    =	$block['offset'],
					array(
						'name'   => esc_html__( 'Offset - number of posts to pass over', HERBS_TEXTDOMAIN ),
						'id'     => 'offset',
						'type'   => 'number',
				...
				tie_page_builder_option(
					...
					array(
						...
						'options' => array(
								...
								'next-prev' => esc_html__( 'Next and Previous Arrows', HERBS_TEXTDOMAIN ),
				...
				if( ! tie_get_option( 'api_youtube' ) ){
					...
					tie_page_builder_option(
						...
						array(
							...
							'text'   => esc_html__( 'You need to set the YouTube API Key in the theme options page > API Keys.', HERBS_TEXTDOMAIN ),
							'type'   => 'error',
				...
				if( HERBS_REVSLIDER_IS_ACTIVE ){
					echo '<div class="block-revslider-settings">';
						...
						if( ! empty( $rev_slider ) && is_array( $rev_slider )){
							...
							$arrSliders = array( '' => esc_html__( 'Choose Slider', HERBS_TEXTDOMAIN ) );
							...
							tie_page_builder_option(
								...
								array(
									'name'    => esc_html__( 'Slider Revolution', HERBS_TEXTDOMAIN ),
									'id'      => 'revslider',
									'type'    => 'select',
									'options' => $arrSliders,
								));
							...
							tie_build_theme_option(
								array(
									'text' => esc_html__( 'No sliders found, add a slider first!', HERBS_TEXTDOMAIN ),
									'type' => 'error',
								));
						}
					...
					echo '<div class="block-lsslider-settings">';
						...
						if( ! empty( $ls_sliders ) && is_array( $ls_sliders ) ){
							...
							tie_page_builder_option(
								...
								array(
									'name'    => esc_html__( 'LayerSlider', HERBS_TEXTDOMAIN ),
									'id'      => 'lsslider',
									'type'    => 'select',
									'options' => $arrSliders,
								));
			...
			echo '<div class="advanced-block-settings block-settings">';
				...
				tie_page_builder_option(
					...
					array(
						'name'   => esc_html__( 'Show the content only?', HERBS_TEXTDOMAIN ),
						'id'     => 'content_only',
						'type'   => 'checkbox',
						'hint'   => esc_html__( 'Without background, padding nor borders.', HERBS_TEXTDOMAIN ),
				...
				tie_page_builder_option(
					...
					$value    = $block['filters'],
					array(
						'name'   => esc_html__( 'Ajax Filters', HERBS_TEXTDOMAIN ),
						'id'     => 'filters',
						'type'   => 'checkbox',
						'hint'   => esc_html__( 'Will not appear if the numeric pagination is active.', HERBS_TEXTDOMAIN ),
				...
				tie_page_builder_option(
					...
					$value    =	$block['more'],
					array(
						'name'   => esc_html__( 'More Button', HERBS_TEXTDOMAIN ),
						'id'     => 'more',
						'type'   => 'checkbox',
						'hint'   => esc_html__( 'Will not appear if the Block URL is empty.', HERBS_TEXTDOMAIN ),
				...
				tie_page_builder_option(
					...
					array(
						'name'   => esc_html__( 'Posts Title Length', HERBS_TEXTDOMAIN ),
						'id'     => 'title_length',
						'type'   => 'number',
				...
				tie_page_builder_option(
					...
					array(
						'name'   => esc_html__( 'Read More Button', HERBS_TEXTDOMAIN ),
						'id'     => 'read_more',
						'type'   => 'checkbox',
				...
				tie_page_builder_option(
					...
					array(
						'name'   => esc_html__( 'Hide thumbnail for the First post', HERBS_TEXTDOMAIN ),
						'id'     => 'thumb_first',
						'type'   => 'checkbox',
				...
				tie_page_builder_option(
					...
					array(
						'name'   => esc_html__( 'Hide small thumbnails', HERBS_TEXTDOMAIN ),
						'id'     => 'thumb_small',
						'type'   => 'checkbox',
				...
				tie_page_builder_option(
					...
					array(
						'name'   => esc_html__( 'Hide thumbnails', HERBS_TEXTDOMAIN ),
						'id'     => 'thumb_all',
						'type'   => 'checkbox',
				...
				tie_page_builder_option(
					...
					array(
						'name'  =>  esc_html__( 'Slider Speed in ms', HERBS_TEXTDOMAIN ),
						'id'    => 'slider_speed',
						'class' => 'block-slider-options block-slider-slider_speed',
						'type'  => 'number',
						'hint'  => sprintf( esc_html__( 'Default is: %s', HERBS_TEXTDOMAIN ), 3000 ),
					));
				...
				echo '<div class="block-breaking-news-options">';
					...
					tie_page_builder_option(
						...
						array(
							'name'    => esc_html__( 'Animation Effect', HERBS_TEXTDOMAIN ),
							'id'      => 'breaking_effect',
							'type'    => "select",
							'options' => array(
								'reveal'     => esc_html__( 'Typing',        HERBS_TEXTDOMAIN ),
								'flipY'      => esc_html__( 'Fading',        HERBS_TEXTDOMAIN ),
								'slideLeft'  => esc_html__( 'Sliding Left',  HERBS_TEXTDOMAIN ),
								'slideRight' => esc_html__( 'Sliding Right', HERBS_TEXTDOMAIN ),
								'slideUp'    => esc_html__( 'Sliding Up',    HERBS_TEXTDOMAIN ),
								'slideDown'  => esc_html__( 'Sliding Down',  HERBS_TEXTDOMAIN ),
						)));
					...
					tie_page_builder_option(
						...
						array(
							'name' => esc_html__( 'Show the scrolling arrows?', HERBS_TEXTDOMAIN ),
							'id'   => 'breaking_arrows',
							'type' => 'checkbox',
					));
...
function tie_builder_blocks_styles(){
	...
	$builder_blocks_styles =
		array(
			'default'              => array( sprintf( esc_html__( 'Block #%s', HERBS_TEXTDOMAIN ), '1' )  => array( 'block-blog'            => $blocks_path .'block-default.png',              'number' => 5 )),
			'li'                   => array( sprintf( esc_html__( 'Block #%s', HERBS_TEXTDOMAIN ), '2' )  => array( 'block-li'              => $blocks_path .'block-li.png',                   'number' => 5 )),
			'1c'                   => array( sprintf( esc_html__( 'Block #%s', HERBS_TEXTDOMAIN ), '3' )  => array( 'block-1c'              => $blocks_path .'block-1c.png',                   'number' => 5 )),
			'2c'                   => array( sprintf( esc_html__( 'Block #%s', HERBS_TEXTDOMAIN ), '4' )  => array( 'block-2c block-2c-cat' => $blocks_path .'block-2c.png',                   'number' => 4 )),
			'big_thumb'            => array( sprintf( esc_html__( 'Block #%s', HERBS_TEXTDOMAIN ), '5' )  => array( 'block-big-thumb'       => $blocks_path .'block-big_thumb.png',            'number' => 6 )),
			'grid'                 => array( sprintf( esc_html__( 'Block #%s', HERBS_TEXTDOMAIN ), '6' )  => array( 'block-grid'            => $blocks_path .'block-grid.png',                 'number' => 5 )),
			'row'                  => array( sprintf( esc_html__( 'Block #%s', HERBS_TEXTDOMAIN ), '7' )  => array( 'block-row'             => $blocks_path .'block-row.png',                  'number' => 12 )),
			'tabs'                 => array( sprintf( esc_html__( 'Block #%s', HERBS_TEXTDOMAIN ), '8' )  => array( 'block-tabs'            => $blocks_path .'block-tabs.png',                 'number' => 5 )),
			'mini'                 => array( sprintf( esc_html__( 'Block #%s', HERBS_TEXTDOMAIN ), '9' )  => array( 'block-mini'            => $blocks_path .'block-mini.png',                 'number' => 6 )),
			'big'                  => array( sprintf( esc_html__( 'Block #%s', HERBS_TEXTDOMAIN ), '10' ) => array( 'block-big'             => $blocks_path .'block-big.png',                  'number' => 4 )),
			'full_thumb'           => array( sprintf( esc_html__( 'Block #%s', HERBS_TEXTDOMAIN ), '11' ) => array( 'block-full-thumb'      => $blocks_path .'block-full_thumb.png',           'number' => 3 )),
			'overlay-title'        => array( sprintf( esc_html__( 'Block #%s', HERBS_TEXTDOMAIN ), '12' ) => array( 'block-overlay-title'   => $blocks_path .'block-overlay-title.png',        'number' => 3 )),
			'content'              => array( sprintf( esc_html__( 'Block #%s', HERBS_TEXTDOMAIN ), '13' ) => array( 'block-content'         => $blocks_path .'block-content.png',              'number' => 3 )),
			'timeline'             => array( sprintf( esc_html__( 'Block #%s', HERBS_TEXTDOMAIN ), '14' ) => array( 'block-timeline'        => $blocks_path .'block-timeline.png',             'number' => 5 )),
			'first_big'            => array( sprintf( esc_html__( 'Block #%s', HERBS_TEXTDOMAIN ), '15' ) => array( 'block-first-big'       => $blocks_path .'block-first_big.png',            'number' => 4 )),
			'overlay-title-center' => array( sprintf( esc_html__( 'Block #%s', HERBS_TEXTDOMAIN ), '16' ) => array( 'block-overlay-title'   => $blocks_path .'block-overlay-title-center.png', 'number' => 3 )),
			'classic-small'        => array( sprintf( esc_html__( 'Block #%s', HERBS_TEXTDOMAIN ), '17' ) => array( 'block-blog block-classic-small' => $blocks_path .'block-classic-small.png',     'number' => 5 )),

			'scroll'     => array( sprintf( esc_html__( 'Scrolling #%s', HERBS_TEXTDOMAIN ), '1' ) => array( 'block-scroll'   => $blocks_path .'block-scroll.png',   'number' => 6 )),
			'scroll_2'   => array( sprintf( esc_html__( 'Scrolling #%s', HERBS_TEXTDOMAIN ), '2' ) => array( 'block-scroll2'  => $blocks_path .'block-scroll_2.png', 'number' => 6 )),
			'scroll_3'   => array( sprintf( esc_html__( 'Scrolling #%s', HERBS_TEXTDOMAIN ), '3' ) => array( 'block-scroll3'  => $blocks_path .'block-scroll_2.png', 'number' => 6 )),
		);

	$builder_blocks_styles = apply_filters( 'Herbs/page_builder_blocks_args', $builder_blocks_styles );
	...
	for( $slider = 1; $slider <= 17; $slider++ ){
		...
		$builder_blocks_styles[ 'slider_' . $slider ] = array( sprintf( esc_html__( 'Slider #%s', HERBS_TEXTDOMAIN ), $slider ) => array( $slide_class => $slide_img, 'number' => $number ) );
	}

	$builder_blocks_styles[ 'slider_50' ] = array( sprintf( esc_html__( 'Slider #%s', HERBS_TEXTDOMAIN ), 18 ) => array( 'block-slider-container slider_50 slider_4' => $blocks_path .'block-slider_50.png', 'number' => 10 ) );

	// Slider Revolution
	if( HERBS_REVSLIDER_IS_ACTIVE ){
		$builder_blocks_styles['revslider'] = array( esc_html__( 'Slider Revolution', HERBS_TEXTDOMAIN ) => array( 'block-sliders-plugins block-revslider' => $blocks_path .'block-revslider.png' ) );
	}

	// LayerSlider
	if( HERBS_LS_Sliders_IS_ACTIVE ){
		$builder_blocks_styles['lsslider'] = array( esc_html__( 'LayerSlider', HERBS_TEXTDOMAIN ) => array( 'block-sliders-plugins block-lsslider' => $blocks_path .'block-lsslider.png' ) );
	}

	// Misc Blocks
	$builder_blocks_styles +=
		array(
			'videos_list'   => array( esc_html__( 'Videos Playlist', HERBS_TEXTDOMAIN ) => array( 'block-video-list'                              => $blocks_path .'block-videos_list.png' ) ),
			'apps_bmi'   	=> array( esc_html__( 'Apps BMI', HERBS_TEXTDOMAIN ) => array( 'block-video-list'                              => $blocks_path .'block-videos_list.png' ) ),
			'breaking'      => array( esc_html__( 'News Ticker', HERBS_TEXTDOMAIN )     => array( 'block-breaking'                                => $blocks_path .'block-breaking.png' ) ),
			'ad'            => array( esc_html__( 'Ad Block', HERBS_TEXTDOMAIN )        => array( 'block-e3lan-1c-container block-e3lan'          => $blocks_path .'block-ad.png' ) ),
			'ad_50'         => array( esc_html__( 'Ad Block', HERBS_TEXTDOMAIN )        => array( 'block-2c block-e3lan-2c-container block-e3lan' => $blocks_path .'block-ad_50.png' ) ),
			'code'          => array( esc_html__( 'Custom Content', HERBS_TEXTDOMAIN )  => array( 'block-code-1c-container block-code'            => $blocks_path .'block-code.png' ) ),
			'code_50'       => array( esc_html__( 'Custom Content', HERBS_TEXTDOMAIN )  => array( 'block-code-2c-container block-2c block-code'   => $blocks_path .'block-code_50.png' ) ),
			'trendslider'  => array( esc_html__( 'Custom Content', HERBS_TEXTDOMAIN )  => array( 'block-code-1c-container block-code'            => $blocks_path .'block-code.png' ) ),
		);


	// WooCommerce Block
	if( HERBS_WOOCOMMERCE_IS_ACTIVE ){
		$builder_blocks_styles['woocommerce']        = array( sprintf( esc_html__( 'WooCommerce #%s', HERBS_TEXTDOMAIN ), '1' ) => array( 'block-woocommerce-normal block-woocommerce' => $blocks_path .'block-woocommerce.png' ) );
		$builder_blocks_styles['woocommerce-slider'] = array( sprintf( esc_html__( 'WooCommerce #%s', HERBS_TEXTDOMAIN ), '2' ) => array( 'block-woocommerce-slider block-woocommerce' => $blocks_path .'block-woocommerce-slider.png' ) );
	}
...
function tie_builder_editor_handler(){
	...
	if( HERBS_ADMIN_HELPER::is_edit_gutenberg() ){
		...
		add_meta_box(
			...
			esc_html__( 'Herbs Builder', HERBS_TEXTDOMAIN ) . ' <small>' . esc_html__( 'The content in the editor above will be ignored.', HERBS_TEXTDOMAIN ) .'</small>',
...
function tie_add_page_builder(){
	...
	$sections       = false;
	$builder_style  = '';
	$inactive_text  = $button_text = esc_html__( 'Enable the Herbs Builder', HERBS_TEXTDOMAIN );
	$active_text    =  esc_html__( 'Disable the Herbs Builder', HERBS_TEXTDOMAIN );
	...
	<div id="tie-page-builder" style="<?php echo esc_attr( $builder_style ) ?>">
		...
		<div class="tie-page-builder postbox">
			...
			<?php
				HERBS_BUILDER_WIDGETS::get_widgets( $sections );
			?>
			...
			<div class="tie-add-new-section-wrapper">
				...
				<a href="#" data-sections="<?php echo esc_attr( $section_id ) ?>" data-post="<?php echo get_the_id(); ?>" class="tie-add-new-section"><span class="dashicons dashicons-plus"></span> <?php esc_html_e( 'Add Section', HERBS_TEXTDOMAIN ) ?></a>
			</div>
