...
function tie_php_disable_upgrade_notice() {
	$message = sprintf( esc_html__( 'This theme requires at least PHP version 5.3. You are running version %s. Please upgrade and try again.', HERBS_TEXTDOMAIN ), phpversion() );
...
function tie_php_disable_customize() {
	wp_die( sprintf( esc_html__( 'This theme requires at least PHP version 5.3. You are running version %s. Please upgrade and try again.', HERBS_TEXTDOMAIN ), phpversion() ), '', array(
		'back_link' => true,
	) );
}
...
function tie_php_disable_preview() {
	if ( isset( $_GET['preview'] ) ) {
		wp_die( sprintf( esc_html__( 'This theme requires at least PHP version 5.3. You are running version %s. Please upgrade and try again.', HERBS_TEXTDOMAIN ), phpversion() ));
	}
}
