...
if( ! class_exists( 'HERBS_AMP' )){
	...
	class HERBS_AMP{
		...
		function __construct(){
			...
			// Translations
			add_filter( 'Herbs/default_translation_texts', array( $this, 'amp_translation_texts' ), 99 );
				...
				if( $recent_posts->have_posts() ){
					...
					$output = '
						<div class="amp-related-posts">
							<span>'. esc_html__( 'Related Articles', HERBS_TEXTDOMAIN ) .'</span>
							<ul>
							';
							...
							while ( $recent_posts->have_posts() ){
								...
								$output .= '
									<li>
										<a href="' . amp_get_permalink( get_the_ID() ) . '">'. get_the_post_thumbnail( null, HERBS_THEME_SLUG.'-image-large' ) . get_the_title() .'</a>
									</li>';
							}
