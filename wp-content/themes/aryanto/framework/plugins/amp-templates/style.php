...
$default_color           = ! empty( $default_color ) ? $default_color : apply_filters( 'Herbs/default_theme_color', '#000' );

$theme_color             = tie_get_option( 'amp_bg_color', '#ffffff' );
$text_color              = HERBS_STYLES::light_or_dark( $theme_color );
...
$header_color            = HERBS_STYLES::light_or_dark( $header_background_color );

$footer_background_color = tie_get_option( 'amp_footer_color', '#222222' );
$footer_color            = HERBS_STYLES::light_or_dark( $footer_background_color );
...
/** HERBS CUSTOM STYLES AND ELEMENTS **/
