 ...
 * Crypto css file
 */
if ( HERBS_CRYPTOALL_IS_ACTIVE || HERBS_WPUC_IS_ACTIVE ){

	add_action( 'wp_enqueue_scripts', 'tie_crypto_enqueue_styles' );
	function tie_crypto_enqueue_styles(){
		wp_enqueue_style( 'tie-css-crypto', HERBS_TEMPLATE_URL.'/assets/css/plugins/crypto'. HERBS_STYLES::is_minified() .'.css', array(), HERBS_DB_VERSION );
	}
}
 ...
 */
add_filter( 'Herbs/shortcodes_check', 'tie_crypto_shortcodes_check', 10, 2 );
