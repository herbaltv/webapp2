...
if( ! class_exists( 'HERBS_JETPACK' )){
	...
	class HERBS_JETPACK{
		...
		function __construct(){
			...
			// Check OpenGraph
			add_filter( 'Herbs/is_opengraph_active', array( $this, 'is_opengraph_active' ) );
			...
			*/
			...
			add_filter( 'Herbs/posts_widget_query', array( $this, 'widget_query' ), 10, 1 );
			...
			if( Jetpack::is_module_active( 'stats' ) ){
				...
				if( tie_get_option( 'tie_post_views' ) == 'jetpack' ){
					...
					$this->count_key = apply_filters( 'Herbs/views_meta_field', 'tie_views' );
				}
			}
		}
