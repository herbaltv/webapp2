	 ...
	 */
	 class TIE_INSTAGRAM_WIDGET extends WP_Widget {
		...
		public function __construct(){
			parent::__construct( 'tie-instagram-theme', apply_filters( 'Herbs/theme_name', 'Herbs' ) .' - '.esc_html__( 'Instagram', HERBS_TEXTDOMAIN ) );
		}
		...
		public function form( $instance ){
			$defaults = array( 'title' => esc_html__( 'Follow Us', HERBS_TEXTDOMAIN), 'media_number' => 9, 'media_link' => 'file' );
			...
			?>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>"><?php esc_html_e( 'Username', HERBS_TEXTDOMAIN) ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'userid' ) ); ?>"><?php esc_html_e( 'User ID', HERBS_TEXTDOMAIN) ?></label>
					...
					<small><a href="<?php echo esc_url( 'https://herbaltv.co.id/go/find-instagram-user-id' ); ?>" target="_blank" rel="nofollow noopener"><?php esc_html_e( 'Find your Instagram User ID.', HERBS_TEXTDOMAIN ); ?></a></small>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr( $this->get_field_id( 'user_data' ) ); ?>"><?php esc_html_e( 'Show the Bio and counters?', HERBS_TEXTDOMAIN) ?></label>
				</p>

				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'media_link' ) ); ?>"><?php esc_html_e( 'Link Images to', HERBS_TEXTDOMAIN) ?> *</label>
					<select id="<?php echo esc_attr( $this->get_field_id( 'media_link' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'media_link' ) ); ?>" class="widefat">
						<option value="file" <?php selected( $media_link, 'file' ); ?>><?php esc_html_e( 'Media File', HERBS_TEXTDOMAIN) ?></option>
						<option value="page" <?php selected( $media_link, 'page' ); ?>><?php esc_html_e( 'Media Page on Instagram', HERBS_TEXTDOMAIN) ?></option>
					</select>
					<small>* <?php esc_html_e( 'Videos always linked to the Media Page on Instagram.', HERBS_TEXTDOMAIN) ?></small>
				</p>
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'media_number' ) ); ?>"><?php esc_html_e( 'Number of Media Items', HERBS_TEXTDOMAIN) ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'button_text' ) ); ?>"><?php esc_html_e( 'Follow Us Button Text', HERBS_TEXTDOMAIN) ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'button_url' ) ); ?>"><?php esc_html_e( 'Follow Us Button URL', HERBS_TEXTDOMAIN) ?></label>
