	 ...
	 */
	 class TIE_LOGIN_WIDGET extends WP_Widget {
		...
		public function __construct(){
			...
			parent::__construct( 'login-widget', apply_filters( 'Herbs/theme_name', 'Herbs' ) .' - '.esc_html__( 'Log In', HERBS_TEXTDOMAIN), $widget_ops );
		}
		...
		public function form( $instance ){
			$defaults = array( 'title' => esc_html__('Log In', HERBS_TEXTDOMAIN)  );
