	 ...
	 */
	 class TIE_FLICKR_PHOTOS extends WP_Widget {
		...
		public function __construct(){
			...
			parent::__construct( 'flickr_photos-widget', apply_filters( 'Herbs/theme_name', 'Herbs' ) .' - '.esc_html__( 'Flickr', HERBS_TEXTDOMAIN), $widget_ops );
		}
		...
		public function widget( $args, $instance ){
			...
			?>
				...
				<a target="_blank" rel="nofollow noopener" href="https://www.flickr.com/photos/<?php echo esc_attr( $instance['flickr_id'] )?>/" class="button dark-btn fullwidth"><?php esc_html_e( 'Follow us on Flickr', HERBS_TEXTDOMAIN ) ?></a>
		...
		public function form( $instance ){
			$defaults = array( 'title' =>esc_html__( 'Flickr', HERBS_TEXTDOMAIN), 'no_of_photos' => 6, 'flickr_display' => 'latest' );
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'flickr_id' ) ); ?>"><?php esc_html_e( 'Flickr ID:', HERBS_TEXTDOMAIN) ?></label>
				...
				<small><a href="<?php echo esc_url( 'http://www.idgettr.com' ); ?>" target="_blank" rel="nofollow noopener"><?php esc_html_e( 'Find your ID at idGettr', HERBS_TEXTDOMAIN ); ?></a></small>
			</p>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'flickr_display' ) ); ?>"><?php esc_html_e( 'Photos Order:', HERBS_TEXTDOMAIN) ?></label>
				<select id="<?php echo esc_attr( $this->get_field_id( 'flickr_display' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'flickr_display' ) ); ?>" class="widefat">
					<option value="latest" <?php selected( $flickr_display, 'latest' ); ?>><?php esc_html_e( 'Most recent', HERBS_TEXTDOMAIN) ?></option>
					<option value="random" <?php selected( $flickr_display, 'random' ); ?>><?php esc_html_e( 'Random', HERBS_TEXTDOMAIN) ?></option>
				</select>
			</p>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'no_of_photos' ) ); ?>"><?php esc_html_e( 'Number of photos to show:', HERBS_TEXTDOMAIN) ?></label>
