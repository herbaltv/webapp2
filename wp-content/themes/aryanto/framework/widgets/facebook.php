	 ...
	 */
	 class TIE_FACEBOOK_WIDGET extends WP_Widget {
		...
		public function __construct(){
			...
			parent::__construct( 'facebook-widget', apply_filters( 'Herbs/theme_name', 'Herbs' ) .' - '.esc_html__( 'Facebook', HERBS_TEXTDOMAIN ), $widget_ops, $control_ops );
		}
			...
			if( ! empty( $instance['page_url'] ) ){
				...
				?>
					...
					<div class="fb-page" data-href="<?php echo esc_url( $instance['page_url'] ) ?>" data-hide-cover="<?php echo ( $hide_cover == 'true'?'true':'false' ) ?>" data-show-facepile="<?php echo ( $show_faces == 'true'?'true':'false') ?>" data-show-posts="<?php echo ($show_stream == 'true'?'true':'false' ) ?>" data-adapt-container-width="true">
						<div class="fb-xfbml-parse-ignore"><a href="<?php echo esc_url($instance['page_url']) ?>"><?php echo esc_html__( 'Find us on Facebook', HERBS_TEXTDOMAIN); ?></a></div>
					</div>
		...
		public function form( $instance ){
			...
			$defaults = array( 'title' => esc_html__( 'Find us on Facebook', HERBS_TEXTDOMAIN) );
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'page_url' ) ); ?>"><?php esc_html_e( 'Page URL:', HERBS_TEXTDOMAIN) ?></label>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'hide_cover' ) ); ?>"><?php esc_html_e( 'Hide cover Photo?', HERBS_TEXTDOMAIN) ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'show_faces' ) ); ?>"><?php esc_html_e( 'Show Faces?', HERBS_TEXTDOMAIN) ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'show_stream' ) ); ?>"><?php esc_html_e( 'Show Stream?', HERBS_TEXTDOMAIN) ?></label>
			</p>
