	 ...
	 */
	 class TIE_ABOUT_WIDGET extends WP_Widget {
		...
		public function __construct(){
			...
			parent::__construct( 'author-bio-widget', apply_filters( 'Herbs/theme_name', 'Herbs' ) .' - '.esc_html__( 'About', HERBS_TEXTDOMAIN ) , $widget_ops );
		}
		...
		public function widget( $args, $instance ){
			...
			if( ! empty( $instance['img'] ) ){
				...
				// WPML
				$instance['img'] = apply_filters( 'wpml_translate_single_string', $instance['img'], HERBS_THEME_SLUG, 'widget_img_'.$this->id );
		...
		public function form( $instance ){
			$defaults = array( 'title' =>esc_html__( 'About', HERBS_TEXTDOMAIN) );
			...
			<p>
				<label for="<?php echo esc_attr(  $this->get_field_id( 'img' ) ); ?>"><?php esc_html_e( 'Image URL', HERBS_TEXTDOMAIN) ?></label>
			...
			<p>
				<label for="<?php echo esc_attr(  $this->get_field_id( 'width' ) ); ?>"><?php esc_html_e( 'Image Width', HERBS_TEXTDOMAIN) ?></label>
			...
			<p>
				<label for="<?php echo esc_attr(  $this->get_field_id( 'height' ) ); ?>"><?php esc_html_e( 'Image Height', HERBS_TEXTDOMAIN) ?></label>
			...
			<p>
				<label for="<?php echo esc_attr(  $this->get_field_id( 'margin_top' ) ); ?>"><?php esc_html_e( 'Image Margin Top', HERBS_TEXTDOMAIN) ?></label>
			...
			<p>
				<label for="<?php echo esc_attr(  $this->get_field_id( 'margin_bottom' ) ); ?>"><?php esc_html_e( 'Image Margin Bottom', HERBS_TEXTDOMAIN) ?></label>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'circle' ) ); ?>"><?php esc_html_e( 'Circle Shape?', HERBS_TEXTDOMAIN) ?></label>
			</p>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'text_code' ) ); ?>"><?php esc_html_e( 'Text', HERBS_TEXTDOMAIN) ?><i></i></label>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'social_icons' ) ); ?>"><?php esc_html_e( 'Show Social Icons?', HERBS_TEXTDOMAIN) ?></label>
			</p>
