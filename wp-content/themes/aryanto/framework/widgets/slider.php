	 ...
	 */
	 class TIE_SLIDER_WIDGET extends WP_Widget {
		...
		public function __construct(){
			...
			parent::__construct( 'tie-slider-widget', apply_filters( 'Herbs/theme_name', 'Herbs' ) .' - '.esc_html__( 'Slider', HERBS_TEXTDOMAIN), $widget_ops );
		}
			...
			<div class="main-slider boxed-slider boxed-five-slides-slider slider-in-widget">
				...
				<div class="main-slider-inner">
                    ...
                    if( tie_get_option( 'lazy_load' )){
                    	?>
                      <div class="slide">
                        <img data-lazy="<?php echo tie_thumb_src( HERBS_THEME_SLUG.'-image-post' ) ?>" src="<?php echo tie_lazyload_placeholder(); ?>" alt="">
                        <div class="slide-bg"></div>
                    		<?php
                    }
                    else{ ?>
                      <div style="<?php echo tie_thumb_src_bg( HERBS_THEME_SLUG.'-image-post' ) ?>" class="slide">
                      <?php
                    }
                    ?>
								...
								if( ! empty( $slider ) ):
									...
									foreach( $slider as $slide ): ?>
										...
										<div style="background-image: url(<?php echo tie_slider_img_src( $slide['id'] , HERBS_THEME_SLUG.'-image-large' ) ?>)" class="slide">
		...
		public function form( $instance ){
			$defaults = array( 'title' => esc_html__( 'Featured Posts', HERBS_TEXTDOMAIN) ,'no_of_posts' => '5', 'cats_id' => '1' );
			...
			$post_order = apply_filters( 'Herbs/Widget/Slider/post_order_args' ,$post_order );


			$sliders    = HERBS_ADMIN_HELPER::get_sliders( true );
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'slider_only' ) ); ?>"><?php esc_html_e( 'Show the Slider only?', HERBS_TEXTDOMAIN) ?></label>
			</p>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'custom_slider' ) ); ?>"><strong><?php esc_html_e( '- OR -', HERBS_TEXTDOMAIN) ?></strong> <?php esc_html_e( 'Custom Slider', HERBS_TEXTDOMAIN ) ?></label>
