	 ...
	 */
	 class TIE_YOUTUBE_WIDGET extends WP_Widget {
		...
		public function __construct(){
			parent::__construct( 'youtube-widget', apply_filters( 'Herbs/theme_name', 'Herbs' ) .' - '.esc_html__( 'YouTube', HERBS_TEXTDOMAIN ) );
		}
		...
		public function form( $instance ){
			$defaults = array( 'title' =>esc_html__( 'Subscribe to our channel', HERBS_TEXTDOMAIN) );
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'page_url' ) ) ?>"><?php esc_html_e( 'Channel Name or ID:', HERBS_TEXTDOMAIN) ?></label>
				...
				<small><a href="<?php echo esc_url( 'https://www.youtube.com/account_advanced' ); ?>" target="_blank" rel="nofollow noopener"><?php esc_html_e( 'Get it from your account advanced page.', HERBS_TEXTDOMAIN) ?></a></small>
			</p>
