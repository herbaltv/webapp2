	 ...
	 */
	 class TIE_ADS125_WIDGET extends WP_Widget {
		...
		public function __construct(){
			...
			parent::__construct( 'stream-item-125-widget', apply_filters( 'Herbs/theme_name', 'Herbs' ) .' - '.esc_html__( 'Ads 125 x 125', HERBS_TEXTDOMAIN ) , $widget_ops );	}
		...
		public function widget( $args, $instance ){
			...
			for($i=1 ; $i<11 ; $i++ ){
				...
				if( ! empty( $instance['e3lan'.$i.'_code'] )){
					echo'<li>';
					echo do_shortcode( apply_filters( 'Herbs/Ad_widget/code', $instance['e3lan'.$i.'_code'] ) );
					echo '</li>';
				}
				...
				elseif( ! empty( $instance['e3lan'.$i.'_img'] )){
					...
					if( ! empty( $instance['e3lan'.$i.'_url'] )){
						...
						$url = apply_filters( 'Herbs/ads_url', $instance['e3lan'.$i.'_url'] );
						echo '<a href="'. esc_url( $url ) .'"'. $new_window . $nofollow .'>';
					}

					echo apply_filters( 'Herbs/Ad_widget/image', '<img class="widget-ad-image" src="'. $instance['e3lan'.$i.'_img'] .'" width="125" height="125" alt="">', $instance['e3lan'.$i.'_img'] );
		...
		public function form( $instance ){
			$defaults = array( 'title' =>esc_html__( 'Advertisement', HERBS_TEXTDOMAIN) );
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'tran_bg' ) ); ?>"><?php esc_html_e( 'Show the ads only?', HERBS_TEXTDOMAIN) ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'new_window' ) ); ?>"><?php esc_html_e( 'Open links in a new window?', HERBS_TEXTDOMAIN) ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'nofollow' ) ); ?>"><?php esc_html_e( 'Nofollow?', HERBS_TEXTDOMAIN) ?></label>
			</p>

			<?php

			for($i=1 ; $i<11 ; $i++ ){ ?>
				<strong class="tie-widget-sub-title"><?php printf( esc_html__( 'Ad #%s', HERBS_TEXTDOMAIN), $i ) ?></strong>
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'e3lan'.$i.'_img' ) ); ?>"><?php esc_html_e( 'Image path:', HERBS_TEXTDOMAIN ) ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'e3lan'.$i.'_url' ) ); ?>"><?php esc_html_e( 'Ad URL', HERBS_TEXTDOMAIN ) ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'e3lan'.$i.'_code' ) ); ?>"><strong><?php esc_html_e( '- OR -', HERBS_TEXTDOMAIN) ?></strong> <?php esc_html_e( 'Code:', HERBS_TEXTDOMAIN ) ?></label>
	 ...
	 */
	 class TIE_AD_WIDGET extends WP_Widget {
		...
		public function __construct(){
			...
			parent::__construct( 'stream-item-widget', apply_filters( 'Herbs/theme_name', 'Herbs' ) .' - '.esc_html__( 'Ad', HERBS_TEXTDOMAIN ) , $widget_ops );	}
		...
		public function widget( $args, $instance ){
			...
			if( ! empty( $instance['e3lan_code'] )){
				echo do_shortcode( apply_filters( 'Herbs/Ad_widget/code', $instance['e3lan_code'] ) );
			}

			elseif( ! empty( $instance['e3lan_img'] )){
				if( ! empty( $instance['e3lan_url'] )){

					$url = apply_filters( 'Herbs/ads_url', $instance['e3lan_url'] );
					echo '<a href="'. esc_url( $url ) .'"'. $new_window . $nofollow .'>';
				}

				echo apply_filters( 'Herbs/Ad_widget/image', '<img class="widget-ad-image" src="'. $instance['e3lan_img'] .'" width="728" height="90" alt="'. $alt_text .'">', $instance['e3lan_img'] );
		...
		public function form( $instance ){
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'e3lan_title' ) ); ?>"><?php esc_html_e( 'Ad Title', HERBS_TEXTDOMAIN ) ?></label>
				...
				<small><?php esc_html_e( 'A title for the Ad, like Advertisement - leave this empty to disable.', HERBS_TEXTDOMAIN ); ?></small>
			</p>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'e3lan_title_link' ) ); ?>"><?php esc_html_e( 'Ad Title Link', HERBS_TEXTDOMAIN ) ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'e3lan_img' ) ); ?>"><?php esc_html_e( 'Image path:', HERBS_TEXTDOMAIN ) ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'e3lan_alt' ) ); ?>"><?php esc_html_e( 'Alternative Text For The image', HERBS_TEXTDOMAIN ) ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'e3lan_url' ) ); ?>"><?php esc_html_e( 'Ad URL', HERBS_TEXTDOMAIN ) ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'e3lan_code' ) ); ?>"><strong><?php esc_html_e( '- OR -', HERBS_TEXTDOMAIN) ?></strong> <?php esc_html_e( 'Code:', HERBS_TEXTDOMAIN ) ?></label>
