	 ...
	 */
	 class TIE_CATEGORIES_WIDGET extends WP_Widget {
		...
		public function __construct(){
			...
			parent::__construct( 'tie-widget-categories', apply_filters( 'Herbs/theme_name', 'Herbs' ) .' - '.esc_html__( 'Categories', HERBS_TEXTDOMAIN), $widget_ops );
		}
		...
		public function form( $instance ){
			$defaults = array( 'title' => esc_html__('Categories', HERBS_TEXTDOMAIN)  );
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'depth' ) ); ?>"><?php esc_html_e( 'Show child categories?', HERBS_TEXTDOMAIN) ?></label>
			</p>
		<?php
		}
	}
