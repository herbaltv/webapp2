	 ...
	 */
	 class TIE_SOCIAL_WIDGET extends WP_Widget {
		...
		public function __construct(){
			...
			parent::__construct( 'social', apply_filters( 'Herbs/theme_name', 'Herbs' ) .' - '.esc_html__( 'Social Icons', HERBS_TEXTDOMAIN) , $widget_ops );
		}
		...
		?>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'tran_bg' ) ); ?>"><?php esc_html_e( 'Show the social icons only?', HERBS_TEXTDOMAIN) ?></label>
			</p>
