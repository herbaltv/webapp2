	 ...
	 */
	 class TIE_SOUNDCLOUD_WIDGET extends WP_Widget {
		...
		public function __construct(){
			...
			parent::__construct( 'tie-soundcloud-widget', apply_filters( 'Herbs/theme_name', 'Herbs' ) .' - '.esc_html__( 'SoundCloud', HERBS_TEXTDOMAIN) , $widget_ops );
		}
		...
		public function form( $instance ){
			$defaults = array( 'title' => esc_html__( 'SoundCloud', HERBS_TEXTDOMAIN ) );
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'url' ) ); ?>"><?php esc_html_e( 'URL', HERBS_TEXTDOMAIN) ?></label>
			...
			<p>
				...
				<label for="<?php echo esc_attr( $this->get_field_id( 'autoplay' ) ); ?>"><?php esc_html_e( 'Autoplay?', HERBS_TEXTDOMAIN) ?></label>
			</p>
		  <?php
		}
	}
