	 ...
	 */
	 class TIE_COMMENTS_AVATAR extends WP_Widget {
		...
		public function __construct(){
			...
			parent::__construct( 'comments_avatar-widget', apply_filters( 'Herbs/theme_name', 'Herbs' ) .' - '.esc_html__( 'Recent Comments with avatar', HERBS_TEXTDOMAIN ) , $widget_ops, $control_ops );
		}
		...
		public function form( $instance ){
			$defaults = array( 'title' => esc_html__( 'Recent Comments', HERBS_TEXTDOMAIN ), 'no_of_comments' => 5 );
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'no_of_comments' ) ); ?>"><?php esc_html_e( 'Number of comments to show:', HERBS_TEXTDOMAIN) ?></label>
