	...
	function Autocomplete(el, options) {
		var noop = function () { },
			...
			defaults = {
				...
				onSearchError: noop,
				preserveInput: false,
				containerClass: '#autocomplete-suggestions', // Herbs use ID
				tabDisabled: false,
				dataType: 'text',
				currentRequest: null,
	...
	Autocomplete.prototype = {
		...
		initialize: function () {
			...
			that.killerFn = function (e) {
				if ($(e.target).closest( /*'.' + */ that.options.containerClass).length === 0) { // By Herbs
			...
			// Herbs Prevent the js from creating the Search results DIV
