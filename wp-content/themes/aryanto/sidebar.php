...
if( ! HERBS_HELPER::has_sidebar() ) return;

// Check if the sidebars is hidden on mobiles
if( HERBS_HELPER::is_mobile_and_hidden( 'sidebars' )) return;
...
elseif( HERBS_BUDDYPRESS_IS_ACTIVE && is_buddypress() ){
	$sidebar   = HERBS_BUDDYPRESS::get_page_data( 'tie_sidebar_post' );
	$is_sticky = HERBS_BUDDYPRESS::get_page_data( 'tie_sticky_sidebar' ) ? HERBS_BUDDYPRESS::get_page_data( 'tie_sticky_sidebar' ) : $is_sticky;
}
// bbPress
