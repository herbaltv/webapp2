 ...
 */
if( ! function_exists( 'herbal_above_post_content_ad' ) ){

	function herbal_above_post_content_ad(){
 ...
 */
if( ! function_exists( 'herbal_widget_posts' ) ){

	function herbal_widget_posts( $query_args, $args ){
...
if( ! function_exists( '_ti' )){
	...
	//	_deprecated_function( __FUNCTION__, '2.1.0', 'esc_html__()' );
		...
		return esc_html__( $text, HERBS_TEXTDOMAIN );
	}
}
...
if( ! function_exists( '_eti' )){
	...
	function _eti( $text ){
		...
		esc_html_e( $text, HERBS_TEXTDOMAIN );
	}
}
 ...
 */
if( ! function_exists( 'herbal_below_post_content_ad' ) ){

	function herbal_below_post_content_ad(){
 ...
 */
if( ! function_exists( 'herbal_above_post_ad' ) ){

	function herbal_above_post_ad(){
 ...
 */
if( ! function_exists( 'herbal_content_column_attr' ) ){

	function herbal_content_column_attr( $echo = true ){
 ...
 */
if( ! function_exists( 'herbal_get_option' ) ){

	function herbal_get_option( $name, $default = false ){
...
/**
 * @since 1.0.0
 * @deprecated 2.1.0 Use HERBS_PAGINATION::show()
 */
if( ! function_exists( 'herbal_pagination' ) ){

	function herbal_pagination( $args = array() ){

		_deprecated_function( __FUNCTION__, '2.1.0', 'HERBS_PAGINATION::show()' );

		HERBS_PAGINATION::show( $args );
	}
}
...
/**
 * @since 1.0.0
 * @deprecated 2.1.0 Use herbal_get_template_part()
 */
if( ! function_exists( 'herbal_get_template_part' ) ){

	function herbal_get_template_part( $template_slug, $template_name = '', $args = array() ){

		_deprecated_function( __FUNCTION__, '2.1.0', 'HERBS_HELPER::get_template_part()' );

		HERBS_HELPER::get_template_part( $template_slug, $template_name, $args );
	}
}
...
/**
 * @since 1.0.0
 * @deprecated 2.1.0 Use HERBS_BUDDYPRESS::get_page_data()
 */
if( ! function_exists( 'herbal_bp_get_page_data' ) ){

	function herbal_bp_get_page_data( $key, $default = false ){

		_deprecated_function( __FUNCTION__, '2.1.0', 'HERBS_BUDDYPRESS::get_page_data()' );

		HERBS_BUDDYPRESS::get_page_data( $key, $default );
	}
}
 ...
 */
if( ! function_exists( 'herbal_bp_get_notifications' ) ){

	function herbal_bp_get_notifications(){
 ...
 */
if( ! function_exists( 'herbal_below_post_ad' ) ){

	function herbal_below_post_ad(){
 ...
 */
if( ! function_exists( 'herbal_author_box' ) ){

	function herbal_author_box( $name = false, $user_id = false ){
 ...
 */
if( ! function_exists( 'herbal_get_postdata' ) ){

	function herbal_get_postdata( $key, $default = false, $post_id = null ){
 ...
 */
if( ! function_exists( 'herbal_get_object_option' ) ){

	function herbal_get_object_option( $key = false, $cat_key = false, $post_key = false ){
 ...
 */
if( ! function_exists( 'herbal_get_ajax_loader' ) ){

	function herbal_get_ajax_loader( $echo = true ){
 ...
 */
if( ! function_exists( 'herbal_category_option' ) ){

	function herbal_category_option( $option ){
 ...
 */
if( ! function_exists( 'herbal_theme_option' ) ){

	function herbal_theme_option( $value ){
 ...
 */
if( ! function_exists( 'herbal_custom_post_option' ) ){

	function herbal_custom_post_option( $value ){
...
/**
 * @since 1.0.0
 * @deprecated 2.1.0 Use HERBS_WOOCOMMERCE::get_page_data()
 */
if( ! function_exists( 'herbal_wc_get_page_data' ) ){

	function herbal_wc_get_page_data( $key, $default = false ){

		_deprecated_function( __FUNCTION__, '2.1.0', 'HERBS_WOOCOMMERCE::get_page_data()' );

		HERBS_WOOCOMMERCE::get_page_data( $key, $default );
	}
}
 ...
 */
if( ! function_exists( 'herbal_thumb_src' ) ){

	function herbal_thumb_src( $size = false ){
 ...
 */
if( ! function_exists( 'herbal_get_category_option' ) ){

	function herbal_get_category_option( $key, $category_id = 0 ){
 ...
 */
if( ! function_exists( 'herbal_get_time' ) ){

	function herbal_get_time( $return = false ){
 ...
 */
if( ! function_exists( 'herbal_the_score' ) ){

	function herbal_the_score( $size = 'small' ){
 ...
 */
if( ! function_exists( 'herbal_thumb_src_bg' ) ){

	function herbal_thumb_src_bg( $size = false ){
 ...
 */
if( ! function_exists( 'herbal_get_score' ) ){

	function herbal_get_score( $size = 'small' ){
 ...
 */
if( ! function_exists( 'herbal_post_thumbnail' ) ){

	function herbal_post_thumbnail( $thumb = false, $review = 'small', $cat = false, $trending = true ){
 ...
 */
if( ! function_exists( 'herbal_post_class' ) ){

	function herbal_post_class( $classes = false, $post_id = null, $standard = false ){
 ...
 */
if( ! function_exists( 'herbal_the_post_meta' ) ){

	function herbal_the_post_meta( $args = '', $before = false, $after = false ){
 ...
 */
if( ! function_exists( 'herbal_the_title' ) ){

	function herbal_the_title( $limit = false, $trim_type = false ){
 ...
 */
if( ! function_exists( 'herbal_get_primary_category_id' ) ){

	function herbal_get_primary_category_id(){
 ...
 */
if( ! function_exists( 'herbal_get_post_class' ) ){

	function herbal_get_post_class( $classes = false, $post_id = null, $standard = false ){
 ...
 */
if( ! function_exists( 'herbal_the_category' ) ){

	function herbal_the_category( $before = false, $after = false, $primary = true, $plain = false ){
 ...
 */
if( ! function_exists( 'herbal_is_mobile' ) ){

	function herbal_is_mobile(){
 ...
 */
if( ! function_exists( 'herbal_get_banner' ) ){

	function herbal_get_banner( $banner, $before, $after, $echo ){
 ...
 */
if( ! function_exists( 'herbal_is_handheld' ) ){

	function herbal_is_handheld(){
 ...
 */
if( ! function_exists( 'herbal_article_attr' ) ){

	function herbal_article_attr( $attrs ){
	}
}
...
/**
 * @since 1.0.0
 * @deprecated 2.1.0 Use HERBS_HELPER::inline_script()
 */
if( ! function_exists( 'herbal_add_inline_script' ) ){

	function herbal_add_inline_script( $handle, $data, $position = 'after' ){

		_deprecated_function( __FUNCTION__, '2.1.0', 'HERBS_HELPER::inline_script()' );

		HERBS_HELPER::inline_script( $handle, $data, $position );
	}
}
...
/**
 * @since 1.0.0
 * @deprecated 2.1.0 Use HERBS_HELPER::is_mobile_and_hidden()
 */
if( ! function_exists( 'herbal_is_mobile_and_hidden' ) ){

	function herbal_is_mobile_and_hidden( $option ){

		_deprecated_function( __FUNCTION__, '2.1.0', 'HERBS_HELPER::is_mobile_and_hidden()' );

		HERBS_HELPER::is_mobile_and_hidden( $option );
	}
}
 ...
 */
if( ! function_exists( 'herbal_author_social_array' ) ){

	function herbal_author_social_array(){
 ...
 */
if( ! function_exists( 'herbal_get_category' ) ){

	function herbal_get_category( $before = false, $after = false, $primary = true, $plain = false ){
 ...
 */
if( ! function_exists( 'herbal_get_excerpt' ) ){

	function herbal_get_excerpt( $limit ){
 ...
 */
if( ! function_exists( 'herbal_header_class' ) ){

	function herbal_header_class( $custom = '' ){
 ...
 */
if( ! function_exists( 'herbal_the_excerpt' ) ){

	function herbal_the_excerpt( $limit ){
 ...
 */
if( ! function_exists( 'herbal_get_title' ) ){

	function herbal_get_title( $limit = false, $trim_type = false ){
 ...
 */
if( ! function_exists( 'herbal_logo' ) ){

	function herbal_logo(){
 ...
 */
if( ! function_exists( 'herbal_logo_args' ) ){

	function herbal_logo_args( $type ){
 ...
 */
if( ! function_exists( 'herbal_sticky_logo' ) ){

	function herbal_sticky_logo(){
 ...
 */
if( ! function_exists( 'herbal_logo_sticky_args' ) ){

	function herbal_logo_sticky_args(){
 ...
 */
if( ! function_exists( 'herbal_light_or_dark' ) ){

	function herbal_light_or_dark( $color, $return_rgb, $dark , $light ){
 ...
 */
if( ! function_exists( 'herbal_social_networks' ) ){

	function herbal_social_networks(){
 ...
 */
if( ! function_exists( 'herbal_get_social' ) ){

	function herbal_get_social( $options = array() ){
...
/**
 * @since 1.0.0
 * @deprecated 2.1.0 Use HERBS_HELPER::is_sidebar_registered()
 */
if( ! function_exists( 'herbal_is_registered_sidebar' ) ){

	function herbal_is_registered_sidebar( $index ){

		_deprecated_function( __FUNCTION__, '2.1.0', 'HERBS_HELPER::is_sidebar_registered()' );

		HERBS_HELPER::is_sidebar_registered( $index );
	}
}
 ...
 */
if( ! function_exists( 'herbal_video' ) ){

	function herbal_video(){
 ...
 */
if( ! function_exists( 'herbal_video_embed' ) ){

	function herbal_video_embed(){
...
/**
 * @since 1.0.0
 * @deprecated 2.1.0 Use HERBS_HELPER::do_not_dublicate()
 */
if( ! function_exists( 'herbal_do_not_dublicate' ) ){

	function herbal_do_not_dublicate(  $post_id = false ){

		_deprecated_function( __FUNCTION__, '2.1.0', 'HERBS_HELPER::do_not_dublicate()' );

		HERBS_HELPER::do_not_dublicate( $post_id );
	}
}
 ...
 */
if( ! function_exists( 'herbal_wc_full_width_loop_shop_columns' ) ){

	function herbal_wc_full_width_loop_shop_columns(){
 ...
 */
if( ! function_exists( 'herbal_block_title' ) ){

	function herbal_block_title( $block ){
 ...
 */
if( ! function_exists( 'herbal_google_maps' ) ){

	function herbal_google_maps( $url ){
 ...
 */
if( ! function_exists( 'herbal_audio' ) ){

	function herbal_audio( $size ){
 ...
 */
if( ! function_exists( 'herbal_query' ) ){

	function herbal_query( $block ){
 ...
 */
if( ! function_exists( 'herbal_facebook_video' ) ){

	function herbal_facebook_video( $url ){
 ...
 */
if( ! function_exists( 'herbal_twitter_video' ) ){

	function herbal_twitter_video( $url ){
 ...
 */
if( ! function_exists( 'herbal_get_video_embed' ) ){

	function herbal_get_video_embed( $url ){
...
/**
 * @since 1.0.0
 * @deprecated 2.1.0 Use HERBS_POSTVIEWS::get_views()
 */
if( ! function_exists( 'herbal_views' ) ){

	function herbal_views( $text, $post_id ){

		_deprecated_function( __FUNCTION__, '2.1.0', 'HERBS_POSTVIEWS::get_views()' );

		HERBS_POSTVIEWS::get_views( $text, $post_id );
	}
}
 ...
 */
if( ! function_exists( 'herbal_reading_time' ) ){

	function herbal_reading_time(){
 ...
 */
if( ! function_exists( 'herbal_soundcloud' ) ){

	function herbal_soundcloud( $url, $autoplay, $visual ){
 ...
 */
if( ! function_exists( 'herbal_slider_img_src' ) ){

	function herbal_slider_img_src( $image_id, $size ){
 ...
 */
if( ! function_exists( 'herbal_breadcrumbs' ) ){

	function herbal_breadcrumbs(){
