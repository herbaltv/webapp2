...
class HERBAL_OPTIMIZATION_RESOURCES {
...
//
add_filter( 'init', 'herbal_optimization_resources_init' );
function herbal_optimization_resources_init(){

	// This method available in v4.0.0 and above
	if( method_exists( 'HERBS_HELPER','has_builder' ) ){
		new HERBAL_OPTIMIZATION_RESOURCES();
	}
}
