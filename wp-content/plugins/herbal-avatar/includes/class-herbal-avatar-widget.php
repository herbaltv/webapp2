...
class WP_User_Avatar_Profile_Widget extends WP_Widget {
  ...
  public function __construct() {
    $widget_ops = array('classname' => 'widget_wp_user_avatar', 'description' => __('Insert').' '.__('[avatar_upload]', 'herbal-avatar').'.');
    parent::__construct('wp_user_avatar_profile', __('Herbal Avatar', 'herbal-avatar'), $widget_ops);
  }
  ...
  ?>
    <p>
      <label for="<?php echo $this->get_field_id('title'); ?>">
        <?php _e('Title:','herbal-avatar'); ?>
      </label>
      <input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
    </p>
    <label for="<?php echo $this->get_field_id('filter'); ?>"><?php _e('Description:','herbal-avatar'); ?></label>
    ...
    <p>
      ...
      <label for="<?php echo $this->get_field_id('filter'); ?>">
        <?php _e('Automatically add paragraphs','herbal-avatar'); ?>
      </label>
    </p>
  <?php
  }
