    ...
    if(!$this->wrote_footer) {
      ...
      if(defined('W3TC') && defined('WP_DEBUG') && WP_DEBUG && !is_admin()) {
        ...
        if(!did_action('wp_footer')) {
          error_log("We're sorry, but your theme's page template didn't make a call to wp_footer(), which is required by Herbal Avatar. Please add this call to your page templates.");
        } else {
          error_log("We're sorry, but your theme's page template didn't make a call to wp_print_footer_scripts(), which is required by Herbal Avatar. Please add this call to your page templates.");
        }
