...
<html>
<head>
  <title><?php _e('Herbal Avatar', 'herbal-avatar'); ?></title>
...
<body id="link" class="wp-core-ui" onload="document.body.style.display='';" style="display:none;">
  <div id="wpua-tabs">
    <ul>
      <li><a href="#wpua"><?php _e('Avatar','herbal-avatar'); ?></a></li>
      <li><a href="#wpua-upload"><?php _e('Upload','herbal-avatar'); ?></a></li>
    </ul>
    <form name="wpUserAvatar" action="#">
      <div id="wpua">
        <p>
          <label for="<?php esc_attr_e('wp_user_avatar_user'); ?>"><strong><?php _e('User Name','herbal-avatar'); ?>:</strong></label>
        ...
        <p>
          ...
          <select id="<?php esc_attr_e('wp_user_avatar_size'); ?>" name="<?php esc_attr_e('wp_user_avatar_size'); ?>">
            <option value=""></option>
            <option value="original"><?php _e('Original Size','herbal-avatar'); ?></option>
            <option value="large"><?php _e('Large','herbal-avatar'); ?></option>
            <option value="medium"><?php _e('Medium','herbal-avatar'); ?></option>
            <option value="thumbnail"><?php _e('Thumbnail','herbal-avatar'); ?></option>
            <option value="custom"><?php _e('Custom','herbal-avatar'); ?></option>
          </select>
        </p>

        <p id="<?php esc_attr_e('wp_user_avatar_size_number_section'); ?>">
          <label for="<?php esc_attr_e('wp_user_avatar_size_number'); ?>"><?php _e('Size','herbal-avatar'); ?>:</label>
          <input type="text" size="8" id="<?php esc_attr_e('wp_user_avatar_size_number'); ?>" name="<?php esc_attr_e('wp_user_avatar_size'); ?>" value="" />
        </p>

        <p>
          <label for="<?php esc_attr_e('wp_user_avatar_align'); ?>"><strong><?php _e('Alignment','herbal-avatar'); ?>:</strong></label>
          <select id="<?php esc_attr_e('wp_user_avatar_align'); ?>" name="<?php esc_attr_e('wp_user_avatar_align'); ?>">
            <option value=""></option>
            <option value="center"><?php _e('Center','herbal-avatar'); ?></option>
            <option value="left"><?php _e('Left','herbal-avatar'); ?></option>
            <option value="right"><?php _e('Right','herbal-avatar'); ?></option>
          </select>
        </p>
        ...
        <p>
          ...
          <select id="<?php esc_attr_e('wp_user_avatar_link'); ?>" name="<?php esc_attr_e('wp_user_avatar_link'); ?>">
            <option value=""></option>
            <option value="file"><?php _e('Image File','herbal-avatar'); ?></option>
            <option value="attachment"><?php _e('Attachment Page','herbal-avatar'); ?></option>
            <option value="custom-url"><?php _e('Custom URL','herbal-avatar'); ?></option>
          </select>
        </p>

        <p id="<?php esc_attr_e('wp_user_avatar_link_external_section'); ?>">
          <label for="<?php esc_attr_e('wp_user_avatar_link_external'); ?>"><?php _e('URL','herbal-avatar'); ?>:</label>
        ...
        <p>
          ...
          <input type="checkbox" id="<?php esc_attr_e('wp_user_avatar_target'); ?>" name="<?php esc_attr_e('wp_user_avatar_target'); ?>" value="_blank" /> <strong><?php _e('Open link in a new window','herbal-avatar'); ?></strong>
        </p>

        <p>
          <label for="<?php esc_attr_e('wp_user_avatar_caption'); ?>"><strong><?php _e('Caption','herbal-avatar'); ?>:</strong></label>
      ...
      <div id="wpua-upload" style="display:none;">
        <p id="<?php esc_attr_e('wp_user_avatar_upload'); ?>">
          <label for="<?php esc_attr_e('wp_user_avatar_upload'); ?>"><strong><?php _e('Upload','herbal-avatar'); ?>:</strong></label>
        ...
        <div class="mceActionPanel">
          <input type="submit" id="insert" class="button-primary" name="insert" value="<?php _e('Insert into Post','herbal-avatar'); ?>" onclick="wpuaInsertAvatarUpload();" />
        </div>
      </div>
    </form>
  </div>
