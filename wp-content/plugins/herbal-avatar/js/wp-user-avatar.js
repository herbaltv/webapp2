    ...
    wp.media.wpUserAvatar = {
        ...
        set: function(a) {
            ...
            if (b.post.wpUserAvatarId && b.post.wpUserAvatarSrc) {
                $('#herbal-avatar'+id).val(b.post.wpUserAvatarId);
...
jQuery(function($) {
    ...
    $('#your-profile').attr('enctype', 'multipart/form-data');
    var a = $('#herbal-avatar-existing').val();
