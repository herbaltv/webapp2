...
class Herbal_Avatar_Setup {
  ...
  private function _load_wpua() {
    ...
    require_once(WPUA_INC.'class-herbal-avatar-admin.php');
    require_once(WPUA_INC.'class-herbal-avatar.php');
    require_once(WPUA_INC.'class-herbal-avatar-functions.php');
    require_once(WPUA_INC.'class-herbal-avatar-shortcode.php');
    require_once(WPUA_INC.'class-herbal-avatar-subscriber.php');
    require_once(WPUA_INC.'class-herbal-avatar-update.php');
    require_once(WPUA_INC.'class-herbal-avatar-widget.php');
